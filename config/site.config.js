...
module.exports = {
  ...
  footer:
    ...
    `Powered by <a href="https://github.com/${process.env.NEXT_PUBLIC_OWNER ?? 'spencerwooo'}/onedrive-vercel-index" target="_blank" rel="noopener noreferrer">onedrive-vercel-index</a>. Made with ❤ by <span style="text-transform: capitalize;">${process.env.NEXT_PUBLIC_OWNER ?? 'SpencerWoo'}</span>.`,
  ...
  email: `mailto:${process.env.NEXT_PUBLIC_EMAIL ?? 'spencer.wushangbo@gmail.com'}`,
  ...
  links: [
    {
      ...
      link: `https://github.com/${process.env.NEXT_PUBLIC_GITHUB ?? 'spencerwooo/onedrive-vercel-index'}`,
    },
  ],
